...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Concurso  <sup>adso</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('index.php/admin/Inicio/openCreateUser') ?>">Registrar</a>
                        <a class="collapse-item" href="<?= base_url('index.php/admin/Inicio/listUsers') ?>">Mostrar</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="<?= base_url('index.php/Login/cerrarSession') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Cerrar Sesion</a>
                    </div>
                    ...
                    <!-- Content Row --><div class="content-wrapper">
        ...
        <tbody>
          <tr>
            <?php   foreach ($personas as $key => $persona) { ?>
                ...
                <tr>
                    <th scope="row"><?php echo $persona->tipo ?></th>
                    <td><?php echo $persona->cedula  ?></td>
                    <td><?php echo $persona->email  ?></td>
                    <td><?php echo $persona->estado  ?></td>
                    <td > <a href="<?= base_url('index.php/admin/Inicio/modificar/') . $persona->cedula ?>"><button class="btn btn-success">Modificar</button></a></td>
    ...
    <!-- Page level plugins -->
    <script src="<?= base_url('dist/vendor/chart.js/Chart.min.js')?>"></script>
