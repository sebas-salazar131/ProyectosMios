<?php 
$dataHeader['titulo'] = "Crear Administrador";
        ...
        <div class="col-12 m-0 p-3">
            ...
            <?php if (isset($date_validos)): ?>
                <script>
                    Swal.fire({
                        title: 'DATOS VALIDOS',
                        text: 'El Administrador ha sido creado con éxito',
                        icon: 'success',
                    });
                </script>
            <?php endif ?>
            ...
            <div class="row justify-content-center">
                <form class="mx-auto" action="<?= base_url('index.php/admin/Inicio/createAdmin'); ?>" method="POST" enctype="multipart/form-data">

                    <div class="card card-login">
                        <div  class="card-header card-header-primary ">
                            <h4 class=" text-center">Registrar ADMINNISTRADOR</h4>
                        </div>
                    </div>     
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            ...
                            <select class="form-control" id="nuevo_tipo" name="nuevo_tipo" value="ADMIN">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary" name="guardar">Registrar Administrador</button>
                    </div>
                </form>
            </div>
        </div>
