        ...
        <section class="content">
            ...
            <div class="card card-solid">
                <div class="card-body pb-0">
                   <div >
                        <form class="input-group mb-3" method="post" action="<?php echo base_url('index.php/admin/Productos/buscarProducto'); ?>">
                                ...
                                <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
                                    <div class="card bg-light d-flex flex-fill">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="row">
                                                <div class="col-7">
                                                <p class="text-muted text-sm"><b>Precio: </b><?php echo $producto->precio_venta; ?></p>
                                                <p class="text-muted text-sm"><b>Cantidad Disponible: </b><?php echo $producto->cantidad_disponible; ?></p>
                                                <p class="text-muted text-sm"><b>Fecha Vencimiento </b><?php echo $producto->fecha_vencimiento; ?></p>
                                                <p class="text-muted text-sm"><b>Tipo: </b><?php echo $producto->tipo; ?></p>
                                                <p class="text-muted text-sm"><b>Estado: </b><?php echo $producto->estado; ?></p>
                                            </div>
                                        ...
                                        <div class="card-footer">
                                            <div class="text-right text-center">
                                                <a href="<?php echo site_url('admin/Productos/editarProductos/' . $producto->id_producto); ?>" class="btn btn-sm btn-success">
                                                    <i class="fa-solid fa-pen-to-square"></i> Editar
                                                </a>
                                                <a href="<?php echo site_url('admin/Productos/cambiarEstadoProducto/' . $producto->id_producto); ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este producto?');">
