<?php
   $dataHeader['titulo']= "Nuestros Agricultores";
...
<div class="list_agri">
    <div class="mt-5">
        ...
        <form class="input-group mb-3" method="post" action="<?php echo base_url('index.php/SinLog/buscarAgricultores'); ?>">
        ...
        <?php foreach ($agricultores as $agricultor): ?>
            <div class="wrap animate pop"> <!-- Agrega las clases animate y pop aquí -->
                ...
                <div class="text">
                    ...
                    <p class="text-muted text-sm"><b>Estado: </b><?php echo $agricultor->estado; ?></p>
					<a href="<?php echo site_url('admin/Agricultor/productosAgricultor2/' . $agricultor->id_agricultor); ?>"class="btn btn-sm btn-warning">
                        <i class="fa-solid fa-box"></i> Productos
            		</a>
					<br>
					<br>
                    <img src="<?php echo base_url(); ?>assets/dist/imgAgricultores/<?php echo $agricultor->foto ?>" alt="Foto del Agricultor" class="img-circle img-fluid" style="width: 215px; height: 215px;">
