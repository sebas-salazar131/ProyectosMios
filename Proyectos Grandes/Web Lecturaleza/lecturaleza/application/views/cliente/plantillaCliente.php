...
<head>
  ...
  <title>AdminLTE 3 | Intru Felipe Page</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo base_url();?>/assets/index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">ADMINLTE_Felipe</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Jhon Kley Mattar</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= base_url('index.php/usuarios/guardar'); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?= base_url('index.php/personas/guardar'); ?>" class="nav-link">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022-2024 <a href="ADSO">ADSO - 2593917</a>.</strong> All rights reserved.
  </footer>
