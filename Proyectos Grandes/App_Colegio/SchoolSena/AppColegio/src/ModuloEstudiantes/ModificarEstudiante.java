...
public class ModificarEstudiante extends javax.swing.JFrame {
    ...
    MenuProfesor volver;
    public ModificarEstudiante(MenuProfesor volver) {
        this.volver=volver;
        initComponents();
    ...
    private void initComponents() {
        ...
        etqTitulo.setText("MODIFICAR ESTUDIANTE");
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (temporal != null) {
            ...
            campoEmail.setText(temporal.getCorreo());

            campoTelefono.setText(String.valueOf(temporal.getEdad()) );
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        int edad=Integer.parseInt(campoTelefono.getText()) ;
        String correo=campoEmail.getText();
        
        Estudiantes temporal=new Estudiantes(cedula,nombre,apellido,edad,correo);
